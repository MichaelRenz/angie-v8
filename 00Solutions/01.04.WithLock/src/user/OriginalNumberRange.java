...
public final class OriginalNumberRange implements NumberRange {
    private final Lock lock = new ReentrantLock();
    private volatile int lower = 0;
    private volatile int upper = 0;

    public OriginalNumberRange() {
        super();
    }
    public OriginalNumberRange(int l, int u) throws BrokenRangeException {
        lower=l;
        upper=u;
        isValid();
    }
